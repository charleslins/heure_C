...
const vacationJson = {
  ...
  "monthlySummary": {
    ...
    "stats": [
      ...
      { "label": "Jours travaillés effectifs:", "value": "22 jours", "theme": "peach" },
      { "label": "Jours de vacances (droit):", "value": "12 jours", "theme": "purple" },
      { "label": "Jours de vacances (calculés):", "value": "6 jours", "theme": "light-purple" },
      { "label": "Jours fériés:", "value": "1 jour", "theme": "yellow" },
      { "label": "Jours travaillés effectifs:", "value": "16 jours", "theme": "pink" }
    ]
  },
  "publicHolidays": {
    "title": "Jours Fériés en juillet 2025",
    "holidays": [
      { "name": "Natal", "date": "25 déc" }
    ]
  },
  "myVacations": {
...
const VacationPagePreview = ({ onBack }: { onBack: () => void }) => {
  return (
    <div className="p-6">
      <button onClick={onBack} className="mb-4 px-4 py-2 bg-gray-200 rounded">Voltar ao layout anterior</button>
