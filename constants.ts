...
export const DAYS_OF_WEEK: DayOfWeekName[] = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
...
export const USER_COLORS = [
  ...
  'bg-sky-500', 'bg-rose-500', 'bg-cyan-500', 'bg-violet-500', 'bg-lime-500'
];

export const VACATION_STATUS_STYLES: { [key in VacationStatus]: { bg: string; text: string; border?: string } } = {
  [VacationStatus.SELECTED]: { bg: 'bg-blue-100', text: 'text-blue-700', border: 'border-blue-300' },
  [VacationStatus.PENDING_APPROVAL]: { bg: 'bg-yellow-100', text: 'text-yellow-700', border: 'border-yellow-300' },
  [VacationStatus.APPROVED]: { bg: 'bg-green-100', text: 'text-green-700', border: 'border-green-300' },
  [VacationStatus.REJECTED]: { bg: 'bg-red-100', text: 'text-red-700', border: 'border-red-300' },
};
...
export const MOCK_GLOBAL_HOLIDAYS: Holiday[] = [
    { id: 'gh-1', date: `${new Date().getFullYear()}-01-01`, name: 'Ano Novo', isOfficial: true },
    { id: 'gh-2', date: `${new Date().getFullYear()}-05-01`, name: 'Dia do Trabalhador', isOfficial: true },
    { id: 'gh-3', date: `${new Date().getFullYear()}-12-25`, name: 'Natal', isOfficial: true },
];
